...
const properties = propertiesDocs.map(convertToSerializeableObject);
        ...
        return ( <section >
                <div className="container m-auto py-24">
                  <div
                    className="bg-purple-50 px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0"
                  >
                        ...
                        {/* <div className="mb-10">
                          ...
                          <div className="mt-2">
                            <a
                              ...
                              className="bg-purple-500 text-white px-3 py-3 rounded-md mr-2 hover:bg-blue-600"
                            >
                               Edit
                            </a>
                            <button
                              className="bg-red-500 hover:bg-purple-700 text-white font-bold py-4 px-4 text-xs rounded-md"
                              type="button"
                            >
                             <Trash2 size={20} />
                            </button>
